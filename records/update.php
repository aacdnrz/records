...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($checkResult->num_rows > 0) {
        // Student number exists, proceed with the update
        $updateSql = "UPDATE student_records SET Name='$name', Section='$section' WHERE `Student Number`='$studentNumber'";
        ...
        // Student number does not exist, show invalid input alert
